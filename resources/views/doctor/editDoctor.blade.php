...
<div class="container">
	...
	@foreach($profile as $profile)
		<form method="POST" class="form-horizontal" action="/admin/doctor/{{$profile->id}}">
			...
			<!--Qualification of the doc-->
			<div class="form-group">
				<label class="col-md-4 control-label">
					Qualification
				</label>
				<div class="col-md-6">
					<input type="text" class="form-control" name="qualification" value="{{$profile->qualification}}">
				</div>
			</div> 

			<!--Specialism of the doc-->
			<div class="form-group">
				<label class="col-md-4 control-label">
					Specialism
				</label>
				<div class="col-md-6">
					<input type="text" class="form-control" name="specialism" value="{{$profile->specialism}}">
				</div>
			</div> 
			...
			<div class="form-group">
				<div class="col-md-6 col-md-offset-4">
					<button class="btn btn-primary form-control">	Edit Doctor
